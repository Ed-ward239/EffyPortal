      ...
      <div className="btnContainer">
        <div className="glassmorphic">
          <div className="imgBox">
            <i className="cclPic"><img className="carnivalPic"src={Carnival} alt="Carnival"/></i>
          </div>
          <h3>Carnival Cruise Line Invoice Data</h3>
          <div className="contentBoxCCL">
            <button onClick={clickCarnival}>Carnival</button>
          </div>
        </div>
        <div className="glassmorphic">
          <div className="imgBox">
          <i className="nclPic"><img className="norwegianPic"src={Norwegian} alt="Norwegian"/></i>
          </div>
          <h3>Norwegian Cruise Line Invoice Data</h3>
          <div className="contentBoxNCL">
            <button onClick={clickNCL}>Norwegian</button>
          </div>
        </div>
        <div className="glassmorphic">
          <div className="imgBox">
            <i className="otherPic"><DirectionsBoatRoundedIcon style={{ fontSize: '5.5rem' }}/></i>
          </div>
          <div className="contentBoxOther">
            <h3>Other</h3>
            <button onClick={clickOther}>Other</button>
          </div>
        </div>
      </div>
